...
const ProjectDetails = () => {
  ...
  const calculateTotalCompletedProjects = () => {
    return works.filter((item) => item.status === "Completed").length;
  };
  ...
  const calculateTotalCompletedTasks = () => {
    return works
      ...
      .reduce((total, item) => total + item.tasks.length, 0);
  };
                ...
                <ItemWrapper>
                  <Top>
                    <Text>
                      ...
                      <Span>(
                        {calculateTotalCompletedProjects()} projects, {calculateTotalCompletedTasks()} tasks)</Span>
                    </Text>
                  </Top>
                  <ResponsiveMasonry columnsCountBreakPoints={{ 350: 1, 750: 2, 900: 2 }}>
                    <Masonry gutter="14px">
